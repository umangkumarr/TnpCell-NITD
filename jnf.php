...
<body class="host_version"> 
    ...
    <div id="contact" class="section wb" style="background: #ede7f6;">
        <div class="container" style="display: flex;flex-direction: column;align-items: center;justify-content: center;background: #ede7f6;margin-top: -20px;">
            ...
            <a class="hover-btn-new smjnf" href="jnfsummer.html" style="padding: 0 4px;position: absolute;top: 100px;right: 30px;"><span style="padding: 0;margin: 0;font-weight: 500;">Fill Summer JNF/JAF</span></a>

            <div class="section-title text-center">
                <h3 style="color: #eea412;margin-top: 50px;">FILL THE JNF/JAF</h3>
			...
			<script>
				$(document).ready(function(){
					...
					if(w>764){
						$("#googleform").html("<iframe src='https://docs.google.com/forms/d/e/1FAIpQLSdMh11Nb5I1yAifpQDhbLxRwP7CA6Amn6gFQ__ftgQBK404ww/viewform?embedded=true' width='640' height='1250' frameborder='0' marginheight='0' marginwidth='0' style='scroll-behavior: smooth;margin-bottom: 20px;margin-top: -200px;background: #ede7f6;margin-right: 0;margin-left: 0;padding: 0;border-radius: 20px;'>Loading…</iframe>")
					}else if(w>400 && w<=764){
						$("#googleform").html("<iframe src='https://docs.google.com/forms/d/e/1FAIpQLSdMh11Nb5I1yAifpQDhbLxRwP7CA6Amn6gFQ__ftgQBK404ww/viewform?embedded=true' width='90%' height='1300' frameborder='0' marginheight='0' marginwidth='0' style='scroll-behavior: smooth;margin-bottom: 20px;margin-top: -200px;background: #ede7f6;margin-right: 0;margin-left: 0;padding: 0;border-radius: 20px;'>Loading…</iframe>");
					}else if(w<=400){
						$("#googleform").html("<iframe src='https://docs.google.com/forms/d/e/1FAIpQLSdMh11Nb5I1yAifpQDhbLxRwP7CA6Amn6gFQ__ftgQBK404ww/viewform?embedded=true' width='106%' height='1300' frameborder='0' marginheight='0' marginwidth='0' style='scroll-behavior: smooth;margin-bottom: 20px;margin-top: -10px;background: #ede7f6;margin-right: 0;margin-left: 0;padding: 0;border-radius: 20px;'>Loading…</iframe>");
